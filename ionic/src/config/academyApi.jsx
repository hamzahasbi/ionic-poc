...
export const getAcademyNodes = (
  ...
  let categoryFilter = {
    'filter[taxonomy_term--vactory_academy_themes][condition][path]':
      'field_vactory_theme.drupal_internal__tid',
  ...
  return FactoryAPI.getResourcesV2(endpointUrl, 'node/vactory_academy', {
    ...
    fields: {
      'node--vactory_academy':
        'drupal_internal__nid,internal_user,langcode,title,path,field_vactory_date,field_vactory_excerpt,field_vactory_theme',
      'user--user':
        'field_about_the_author,field_first_name,field_last_name,field_user_profession,user_picture',
      'file--image': 'uri',
...
export const getAcademyById = (id, language) => {
  ...
  return FactoryAPI.getResourcesV2(endpointUrl, 'node/vactory_academy', {
    ...
    fields: {
      'node--vactory_academy':
        'drupal_internal__nid,internal_user,langcode,title,path,metatag_normalized,field_vactory_paragraphs,field_vactory_date,field_vactory_excerpt,field_vactory_youtube_videos,field_vactory_file,field_vactory_theme,node_banner_image,node_banner_mobile_image,node_banner_title,node_banner_icon,node_banner_hide_title,node_banner_hide_icon,field_contenu_lie,node_parallax,node_class,field_nid,field_utiliser_disqus',
      'paragraph--vactory_component':
        'drupal_internal__id,paragraph_identifier,paragraph_container,paragraph_css_class,paragraph_background_color,paragraph_background_parallax,paragraph_background_image,field_titre_ancre,field_vactory_component,field_vactory_flag,field_vactory_flag_2,field_vactory_title',
    ...
    include:
      'field_vactory_paragraphs,field_vactory_paragraphs.paragraph_background_image,field_vactory_paragraphs.paragraph_background_image.thumbnail,field_vactory_file,field_vactory_theme,node_banner_image,node_banner_mobile_image,node_banner_image.thumbnail,node_banner_mobile_image.thumbnail',
  });
};
